package com.jxl.soundcloud.components
{
	...
	public class MenuInputText extends InputText
	{
		...
		private var textInputBackgroundFactory:ClassFactory;
		...
		protected override function addChildren():void
		{
			...
			var classFactory:ClassFactory = getTextInputBackgroundFactory();
			
			textInputBackground = classFactory.newInstance() as Sprite;
		...
		protected function getTextInputBackgroundFactory():ClassFactory
		{
			return new ClassFactory(TextInputBackgroundImage);
		}
