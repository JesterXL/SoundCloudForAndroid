 ...
 * 
 * Dan Florio ( polyGeek )
 * http://polygeek.com/2846_flex_adding-physics-to-your-gestures
 * 
 * James Ward
 * http://www.jamesward.com/2010/02/19/flex-4-list-scrolling-on-android-with-flash-player-10-1/
 * 
 * FlepStudio
 * http://www.flepstudio.org/forum/flepstudio-utilities/4973-tipper-vertical-scroller-iphone-effect.html
 * 
...
package 
{
	...
	public class TouchList extends Component
	{
		//------- List --------
		...
		public function TouchList(parent:DisplayObjectContainer=null, xpos:Number=0, ypos:Number=0)
		{
		...
		public override function draw():void
		{
			...
			list.graphics.drawRect(0, 0, width, height)
			...
			const children:Number = list.numChildren;
